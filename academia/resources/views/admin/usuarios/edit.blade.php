                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" class="form-control" value="{{ old('password',$usuario->password) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"><input id="imagen" name="imagen" size="30" type="file" /><p style="color: red">La imagen será reemplazada</p></div>
                                </div>
